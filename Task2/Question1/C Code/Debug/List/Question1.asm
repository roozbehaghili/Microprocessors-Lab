...
;#include <delay.h>
;
;int Seg[10] = {0b00111111 , 0b00000110 , 0b01011011 , 0b01001111 , 0b01100110 , 0b01101101 , 0b01111101 , 0b00000111 ,0b ...
...
; 0000 0023     TimerOverFlowCounter++;
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
; 0000 0024         if(TimerOverFlowCounter == 61 ){
	LDI  R30,LOW(61)
	LDI  R31,HIGH(61)
	CP   R30,R4
	CPC  R31,R5
...
; 0000 0026           if(i < 10){
	...
	CPC  R7,R31
	BRLT _0xB
; 0000 0027            PORTC =  Seg[i];
; 0000 0028          }else{
; 0000 0029            i = 0 ;
	CLR  R6
	CLR  R7
; 0000 002A            PORTC = Seg[i];
_0xB:
	MOVW R30,R6
	LDI  R26,LOW(_Seg)
	LDI  R27,HIGH(_Seg)
...
; 0000 0030         }
; 0000 0031 
; 0000 0032 TCNT1H=0xFF;
_0x4:
	LDI  R30,LOW(255)
	OUT  0x2D,R30
; 0000 0033 TCNT1L=0xF5;
	LDI  R30,LOW(245)
	OUT  0x2C,R30
; 0000 0034 
; 0000 0035 }
...
; 0000 003D TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 003E TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (1<<CS11) | (0<<CS10);
	LDI  R30,LOW(2)
	OUT  0x2E,R30
; 0000 003F TCNT1H=0xFF;
	LDI  R30,LOW(255)
	OUT  0x2D,R30
; 0000 0040 TCNT1L=0xF5;
	LDI  R30,LOW(245)
	OUT  0x2C,R30
; 0000 0041 
; 0000 0042 // Timer(s)/Counter(s) Interrupt(s) initialization
; 0000 0043 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(4)
	OUT  0x39,R30
; 0000 0044 
